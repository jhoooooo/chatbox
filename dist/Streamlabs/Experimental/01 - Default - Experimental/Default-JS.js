...
document.addEventListener('onEventReceived', function (obj) {
    ...
    if (obj.detail.command === "PRIVMSG") {
        ...
        if (typeof obj.detail.tags["reply-parent-msg-body"] != "undefined") {
            ...
            last_elem.before(`<div class='reply_to message'><?xml version="1.0" encoding="UTF-8"?>
            <svg width="1em" fill="currentColor" viewBox="-2 -2.5 24 24" xmlns="http://www.w3.org/2000/svg">
