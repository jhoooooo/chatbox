...
//custom field example that is tied to this is not included.
...
let triggerWord = "{trigger_word}"; //custom field parameter. put text input there so easy for user to update.
